% Create a job and Docker run script for testing VirtualScenesEngine.
%
% This script will produce a job struct suitable for running all the
% VirtualScenesEngine unit tests.
%
...
%   deploy VirtualScenesEngine
%   invoke the test runner function

job = mjsJob( ...
    'name', 'testVirtualScenesEngine', ...
    'toolboxCommand', 'tbUse(''VirtualScenesEngine'');', ...
    'jobCommand', { ...
    'cd(fullfile(tbLocateToolbox(''VirtualScenesEngine''), ''test''));', ...
    'tbAssertTestsPass()'});
