...
%% Suck up the whole job script into memory.
%   So we can embed it into the ssh script below.
...
% excape literal ' quotes, so we can enclose it all in ' quotes
%   this looks nasty because matlab needs '' to escape one '
